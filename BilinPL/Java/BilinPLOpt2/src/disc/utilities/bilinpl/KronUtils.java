...
public class KronUtils {
	...
	public static double [][][] getOrderedKronJointFeatureTensor(double [][] instances, double [][] labelFeatures, int [][] ordering) {
		int N = instances.length; //number of training instances 
		//int M = labelFeatures.length; // number of labels
		int M = 10;
		int R = instances[0].length; // instance features length
		int C = labelFeatures[0].length; // label features length 
